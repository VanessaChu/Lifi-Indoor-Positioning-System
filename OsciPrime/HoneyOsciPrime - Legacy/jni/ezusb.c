...
//MODIFIED MDC 2011: removed external and created a funtion in the file below...
...
//MODIFIED MDC 2011: modified to log in Android's logcat
void logerror(const char *format, ...){
	va_list ap;
	va_start(ap, format);
	__android_log_vprint(6, "FXLOAD_USB",  format, ap);
	va_end(ap);
}
/*
